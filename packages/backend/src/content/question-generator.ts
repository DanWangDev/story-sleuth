...
function buildPrompt(
  ...
  const system = [
    ...
    ``,
    `Hard rules:`,
    `  - Output ONE valid JSON object with these fields: text, question_type, exam_boards, difficulty, options, correct_option.`,
    `  - "text" is the question stem (the actual question the student reads). THIS FIELD IS REQUIRED.`,
